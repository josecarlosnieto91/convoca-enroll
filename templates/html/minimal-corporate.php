...
/* Minimal Corporate — clean, borders */
body { padding:<?= $pad ?>px; }
.badge { border-radius:4px; background:<?= $accent_color ?>; }
.meta-item { border:1px solid rgba(255,255,255,0.15); border-radius:6px; background:transparent; }
.meta-item.price { background:#fff; color:<?= $primary_color ?>; border:none; }
.cta { border:2px solid #fff; background:transparent; color:#fff; }
