( function( blocks, element, serverSideRender ) {
    ...
    blocks.registerBlockType( 'convoca-enroll/panel-reservas', {
        edit: function() {
            return el( 'div', { className: 'conv-block-preview', style: { padding: '20px', background: '#f0fdf4', border: '2px dashed #059669', borderRadius: '8px', textAlign: 'center' } },
