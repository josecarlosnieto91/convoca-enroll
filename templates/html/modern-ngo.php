...
/* Modern NGO — bold serif, asymmetric */
...
.badge { background:rgba(255,255,255,0.15); border:1px solid rgba(255,255,255,0.25); }
.title { font-family:"Playfair Display",Georgia,serif; }
.cta { background:<?= $accent_color ?>; color:#fff; border-radius:6px; }
