...
class WP_CLI_Migration extends \WP_CLI_Command
{
    ...
    public function rgpd_prices($args, $assoc_args)
    {
        ...
        $updated_inscriptions = $wpdb->query($wpdb->prepare("
        ...
        // 2. Migrar Actividades: Si no tienen _bde_precio_socio_dia pero sí _bde_precio_general, copiar valor
        ...
        // 3. Eliminar _bde_precio_general de la base de datos para limpiar el CPT
