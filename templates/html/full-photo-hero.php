...
body{position:relative;font-family:'Playfair',Georgia,serif;color:#fff;background:#1a1a1a;page-break-inside:avoid;break-inside:avoid}
.hero{position:absolute;top:0;left:0;width:100%;height:100%;overflow:hidden;background:#1a1a1a}
<?php if(!empty($hero_image)): ?>.hero{background-image:url("<?= $hero_image ?>");background-size:cover;background-position:center}
<?php endif; ?>
.solid{position:absolute;bottom:0;left:0;width:100%;height:100%;background:#1a1a1a;display:none}
.badge{position:absolute;top:80px;left:80px;display:inline-block;padding:8px 20px;font-family:'Montserrat',sans-serif;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:2.5px;background:#ff8700;color:#fff;z-index:1000}
.logo{position:absolute;top:80px;right:80px;max-width:80px;max-height:40px;z-index:1000}
.title{position:absolute;bottom:320px;left:80px;right:80px;font-family:'Playfair',Georgia,serif;font-size:84px;font-weight:700;line-height:1.0;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;color:#fff}
...
.meta-item.price{background:#ff8700;font-weight:700;color:#fff}
...
.org-info{position:absolute;bottom:80px;left:80px;font-family:'Montserrat',sans-serif;font-size:11px;font-weight:400;opacity:0.5;letter-spacing:1px;text-transform:uppercase;color:#fff}
