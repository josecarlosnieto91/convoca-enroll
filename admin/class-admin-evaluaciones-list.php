...
class Admin_Evaluaciones_List {
    ...
    public static function init() {
        ...
        add_filter( 'manage_bdv_evaluacion_posts_columns', [ __CLASS__, 'set_custom_columns' ] );
        add_action( 'manage_bdv_evaluacion_posts_custom_column', [ __CLASS__, 'custom_column_content' ], 10, 2 );
        add_action( 'restrict_manage_posts', [ __CLASS__, 'add_custom_filters' ] );
        add_action( 'pre_get_posts', [ __CLASS__, 'filter_evaluations_by_activity' ] );
    }
