...
class Admin_Actividades
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_post_bde_save_actividad_admin', [$this, 'handle_save_admin']);
        ...
        add_action('admin_post_bde_duplicate_actividad', [$this, 'handle_duplicate']);
    }
    ...
    public function handle_save_admin()
    {
        ...
        $responsables = isset($_POST['responsables']) ? array_map('intval', $_POST['responsables']) : [];
    ...
    public function handle_duplicate(): void
    {
        ...
        // Copy meta keys
        $skip_meta = ['fecha_inicio', 'fecha_fin'];
        foreach (CPT_Actividad::META_KEYS as $key) {
...
class Admin_Actividades_List extends \WP_List_Table
{
    ...
    protected function column_ocupacion($item): string
    {
        ...
        $color = '#2d5a27';
        if ($pct >= 90) $color = '#d63638';
        elseif ($pct >= 70) $color = '#f59e0b';
