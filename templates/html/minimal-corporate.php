...
.org-info{position:absolute;bottom:80px;left:80px;font-family:'Montserrat',sans-serif;font-size:11px;font-weight:400;opacity:0.5;letter-spacing:1px;text-transform:uppercase;color:#1a1a1a}
